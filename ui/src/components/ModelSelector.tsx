  ...
  return (
    <div className={`relative ${className}`}>
      <select
        ...
        className="w-full appearance-none bg-pawn-surface-800 border border-pawn-surface-700 rounded-button pl-3 pr-8 py-2 text-sm text-pawn-text-primary focus:outline-none focus:border-pawn-gold-500 focus:ring-1 focus:ring-pawn-gold-500 cursor-pointer"
      >
