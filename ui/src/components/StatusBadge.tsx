...
const STATUS_STYLES: Record<string, { badge: string; dot?: string }> = {
  ...
  running:            { badge: "bg-pawn-info-500/10 text-pawn-info-400 border border-pawn-info-500/20", dot: "bg-pawn-info-400 animate-pulse" },
...
export const STATUS_BORDER_COLORS: Record<string, string> = {
  ...
  running:            "border-l-pawn-info-500",
