...
export function makeNavigateUi(ctx: AgentToolContext): ToolDefinition {
  return {
    name: "navigate_ui",
    label: "Navigate UI",
    description: "Navigate the user's browser to a specific page in the UI. Valid paths: /dashboard, /pipelines, /pipelines/:id, /pipelines/:id/edit, /pipelines/new, /skills, /skills/:namespace/:name, /blueprints, /approvals, /settings, /runs/:id",
